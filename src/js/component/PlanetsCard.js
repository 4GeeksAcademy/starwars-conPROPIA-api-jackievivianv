...
export const PlanetsCard = (props) => {
	...
	return (
		...
		<button type="button" className={`btn ${styleFavoriteButton} p-3 btn-sm m-3`} onMouseEnter={handleHoverFav} onMouseLeave={handleLeaveFav} onClick={() => { actions.addFavoritesCharacters(props.name, props.id, "planets"); handleClickFavButton(); }} >
